...
partial  class BikeStoresContext : DbContext
{
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E27F65DBEB4");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B483C5C7F3");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB85CE8170AE");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__46596229820A6E79");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D49E16EA3C");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF5F1EA9447");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9C73AB12D3");

            entity.ToTable("staffs", "sales");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E6164D6DC27DA").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D3227027CC");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30CC429D47D");
